...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot1():
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot2():
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot3():
    import matplotlib.pyplot as plt
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot4():
    import matplotlib.pyplot as plt
    # CDELT1 vs CRVAL1 diagram (normalized coordinates)
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot5():
    import matplotlib.pyplot as plt
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot6():
    import matplotlib.pyplot as plt
    # CDELT1 vs CRVAL1 diagram (normalized coordinates)
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot7():
    import matplotlib.pyplot as plt
...
@pytest.mark.skipif("True")
def test_arccalibration_direct_plot8():
    import matplotlib.pyplot as plt
    # CDELT1 vs CRVAL1 diagram (normalized coordinates)
...
if __name__ == '__main__':
    ...
    test_arccalibration_direct_plot1()
    test_arccalibration_direct_plot2()
    test_arccalibration_direct_plot3()
    test_arccalibration_direct_plot4()
    test_arccalibration_direct_plot5()
    test_arccalibration_direct_plot6()
    test_arccalibration_direct_plot7()
    test_arccalibration_direct_plot8()